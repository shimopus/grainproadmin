...
import pro.grain.admin.domain.Authority;
import pro.grain.admin.domain.User;
import pro.grain.admin.repository.AuthorityRepository;
import pro.grain.admin.repository.PersistentTokenRepository;
import pro.grain.admin.repository.UserRepository;
import pro.grain.admin.repository.search.UserSearchRepository;
import pro.grain.admin.security.AuthoritiesConstants;
import pro.grain.admin.security.SecurityUtils;
import pro.grain.admin.service.util.RandomUtil;
import pro.grain.admin.web.rest.vm.ManagedUserVM;
