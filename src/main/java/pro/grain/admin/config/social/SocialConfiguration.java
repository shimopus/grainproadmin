package pro.grain.admin.config.social;

import pro.grain.admin.repository.SocialUserConnectionRepository;
import pro.grain.admin.repository.CustomSocialUsersConnectionRepository;
import pro.grain.admin.security.social.CustomSignInAdapter;
